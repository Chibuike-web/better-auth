	...
	const handleSubmit = async (e: FormEvent) => {
		...
		startTransition(async () => {
			try {
				...
				setSignUpError("Unable to reach server. Try again later.");
						...
						<div className="flex flex-col items-start md:flex-row md:items-center gap-6 mb-6">
							<div className="flex flex-col w-full">
								...
								{errors.firstName && (
									<p
										id="first-name-error"
										className={cn("text-red-500 text-[14px] font-medium mt-1")}
									>
										{errors.firstName}
									</p>
								)}
								...
								{!errors.firstName && errors.lastName && (
									<div className="hidden md:block min-h-[48px]"></div>
								)}
							</div>
							<div className="flex flex-col w-full">
								...
								/>
								{errors.lastName && (
									<p id="last-name-error" className="text-red-500 text-[14px] font-medium mt-1">
										{errors.lastName}
									</p>
								)}
